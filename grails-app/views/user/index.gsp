		...
		<div id="list-user" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="hasConfirmedEmail" title="${message(code: 'user.hasConfirmedEmail.label', default: 'Has Confirmed Email')}" />
				...
				<g:each in="${userInstanceList}" status="i" var="userInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatBoolean boolean="${userInstance.hasConfirmedEmail}" /></td>
