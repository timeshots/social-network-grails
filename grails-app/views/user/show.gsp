	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.hasConfirmedEmail}">
				<li class="fieldcontain">
					<span id="hasConfirmedEmail-label" class="property-label"><g:message code="user.hasConfirmedEmail.label" default="Has Confirmed Email" /></span>
					
						<span class="property-value" aria-labelledby="hasConfirmedEmail-label"><g:formatBoolean boolean="${userInstance?.hasConfirmedEmail}" /></span>
